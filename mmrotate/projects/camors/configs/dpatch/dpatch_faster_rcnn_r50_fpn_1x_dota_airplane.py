...
# model settings
model = dict(
    type='DPatchFasterRCNN',
    patch_size=patch_size,
    # patch_dir=pwd_dir + 'dpatch_fr_plane/10.npy',
    adv_img_dir=pwd_dir + 'dpatch_fr_plane/adv_img/',
...
train_pipeline = [
    ...
    dict(type='DPatchEditBbox', patch_width=patch_size),
...
custom_hooks = [
    dict(type='SavePatchHook', patch_dir=pwd_dir + 'dpatch_fr_plane/')
]

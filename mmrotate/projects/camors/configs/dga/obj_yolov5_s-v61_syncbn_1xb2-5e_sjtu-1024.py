...
patch_dir = 'patch_lib/obj_yolov5-s_sjtu-1024/'
custom_imports = dict(
...
train_ann_file = 'split_ss_train.json'
train_data_prefix = 'split_ss_train/images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'split_ss_val.json'
val_data_prefix = 'split_ss_val/images/'  # Prefix of val image path
...
model = dict(
    ...
    # patch_dir=pwd_dir + 'patch_lib/obj_yolov5-s_sjtu-1024/5.npy',

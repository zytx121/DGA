...
train_ann_file = 'yolov8_adv_train/annotations/result.json'
train_data_prefix = 'yolov8_adv_train/images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'val/annotations/result.json'
# val_data_prefix = 'val/images/'  # Prefix of val image path
val_data_prefix = 'adv_val_img/'  # Prefix of attacked val image path

...
class APPAFasterRCNN(FasterRCNN):
    ...
    def __init__(self,
        ...
        self.patch_transformer = PatchTransformer(outside=outside)
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        losses = {'tv_loss': tv, 'nps_loss': 0.01 * nps, 'det_loss:': det_loss}

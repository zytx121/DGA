...
exp_name = 'patch_lib/obj_uav_yolov8'
...
model = dict(
    ...
    # patch_dir=pwd_dir + exp_name + '/best.npy',
...
load_from = pwd_dir + 'work_dirs/yolov8_l_syncbn_fast_1xb2-100e_uav/epoch_100-original.pth'  # noqa

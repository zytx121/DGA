...
patch_dir = 'patch_lib/obj_yolov5_sjtu-2250/'
custom_imports = dict(
...
train_ann_file = 'split_ss_train_2250.json'
train_data_prefix = 'split_ss_train_2250/images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'split_ss_val_2250.json'
val_data_prefix = 'split_ss_val_2250/images/'  # Prefix of val image path
...
model = dict(
    ...
    # patch_dir=pwd_dir + 'obj_cowc_yolov5_dr/10.npy',
...
load_from = pwd_dir + 'work_dirs/yolov5_s-v61_syncbn_1xb2-100e_sjtu-1024/epoch_100.pth'  # noqa

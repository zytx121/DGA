...
model = dict(
    ...
    # patch_dir=pwd_dir + 'appa_out_cowc_yolov8/2.npy',
    adv_img_dir=pwd_dir + 'appa_out_cowc_yolov8/adv_img/',
    offset=0,
...
custom_hooks = [
    dict(
        ...
        patch_dir=pwd_dir + 'appa_out_cowc_yolov8/')
]
...
load_from = pwd_dir + 'work_dirs/yolov8_s_syncbn_fast_1xb2-100e_cowc/epoch_100.pth'  # noqa

_base_ = [
    '../_base_/datasets/cowc.py', '../_base_/schedules/schedule_1x.py',
...
model = dict(
    ...
    # patch_dir=pwd_dir + 'appa_out_fr_cowc/5.npy',
    adv_img_dir=pwd_dir + 'appa_out_fr_cowc/adv_img/',
...
custom_hooks = [
    dict(type='SavePatchHook', patch_dir=pwd_dir + 'appa_out_fr_cowc/')
]

load_from = pwd_dir + 'work_dirs/faster_rcnn_r50_fpn_1x_cowc/epoch_12.pth'  # noqa

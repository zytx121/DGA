...
model = dict(
    ...
    # patch_dir=pwd_dir + 'appa_out_cowc_yolov5/10.npy',
    adv_img_dir=pwd_dir + 'appa_out_cowc_yolov5/adv_img/',
...
custom_hooks = [
    dict(
        type='mmdet.SavePatchHook',
        patch_dir=pwd_dir + 'appa_out_cowc_yolov5/')
]
...
load_from = pwd_dir + 'work_dirs/yolov5_s-v61_syncbn_1xb2-100e_cowc/epoch_100.pth'  # noqa

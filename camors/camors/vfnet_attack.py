...
class VFNet_attack(VFNet):
    ...
    def attack(self,
        ...
        results_list = self.bbox_head.attack(
...
@MODELS.register_module()
class VFNetHead_attack(VFNetHead):
    ...
    def attack(self,
        ...
        predictions = self.attack_by_feat(
    ...
    def attack_by_feat(self,
        ...
        for img_id in range(len(batch_img_metas)):
            ...
            results, cls_score, bbox_pred = self._attack_by_feat_single(
                ...
                with_nms=with_nms)
            result_list.append(results)
        return result_list, cls_score, bbox_pred

    def _attack_by_feat_single(self,
        ...
        results_nms = self._bbox_post_process(
            results=results,
            cfg=cfg,
            rescale=rescale,
            with_nms=with_nms,
        ...
        return results_nms, cls_score_list, bbox_pred_list

...
from .patch import DPatchApplier, DPatchTransformer, PatchGenerator


@MODELS.register_module()
class DPatchFasterRCNN(FasterRCNN):
    ...
    def __init__(self,
        ...
        self.patch_applier = DPatchApplier()
        self.patch_transformer = DPatchTransformer()
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        adv_batch_t = self.patch_transformer(patch, img_shape[0])
